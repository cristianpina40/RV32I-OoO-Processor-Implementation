...
HD_PWD='C:/Users/cp123/ooo_core_top/ooo_core_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ooo_core_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ooo_core_top.tcl -notrace
