...
HD_PWD='C:/Users/cp123/ooo_core_top/ooo_core_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ooo_core_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ooo_core_top.tcl
